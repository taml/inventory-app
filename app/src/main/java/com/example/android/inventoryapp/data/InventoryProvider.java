...
public class InventoryProvider extends ContentProvider {
    ...
    static {
        ...
        // For example, "content://com.example.android.inventoryapp/inventory/2" matches, but
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (match) {
            ...
            case INVENTORY_ID:
                ...
                // For an example URI such as "content://com.example.android.inventoryapp/inventory/2",
    ...
    /**
     * Insert an an item into the database with the given content values. Return the new content URI
    ...
    private Uri insertInventory(Uri uri, ContentValues values) {
        ...
        if (supplierEmail == null) {
            throw new IllegalArgumentException("Inventory supplier requires an email address");
        }
     ...
     * specified in the selection and selection arguments (which could be 0 or 1 or more individual items).
